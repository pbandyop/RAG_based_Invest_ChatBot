...
| `data/phase2/index/{run_id}/` | 2 | `index.faiss`, `chunk_metadata.json`, `chunks.jsonl`, `manifest.json` (gitignored except pilot `groww-hdfc-pilot-v1__422a8bf8c13836c8/` for deploy) |

Large binaries should remain **out of git** except the tracked pilot index used for Railway; see root `.gitignore` negation rules.
